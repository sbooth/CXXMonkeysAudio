...
#define APE_NAME                                        L"Monkey's Audio " APE_VER_FILE_VERSION_STR
#define APE_WINAMP_PLUGIN_NAME                          "Monkey's Audio Player " APE_VER_FILE_VERSION_STR
#define APE_MC_PLUGIN_NAME                              L"APE Plugin (v" APE_VER_FILE_VERSION_STR ")"
...
#define APE_RESOURCE_COPYRIGHT                          L"Copyright 2000-" STRINGIZE(APE_YEAR) " Matthew T. Ashland"
#define CONSOLE_NAME                                    L"--- Monkey's Audio Console Front End (v " APE_VER_FILE_VERSION_STR ") " APE_RESOURCE_COPYRIGHT " ---\n"
#define PLUGIN_ABOUT                                    L"Monkey's Audio Player v" APE_VER_FILE_VERSION_STR "\n" APE_RESOURCE_COPYRIGHT
